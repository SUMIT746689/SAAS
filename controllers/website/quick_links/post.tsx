...
async function post(req, res, refresh_token) {
  try {
    ...
    // const singleMenuItem = await prisma.websiteQuickLinks.findFirst({
    //   where: {
    ...
    await prisma.websiteQuickLinks.create({
      data: {
        // ...data,
        english_title,
        bangla_title,
    ...
    return res.json({ message: 'quick Links created successfully!' });
  } catch (err) {
    console.log({ err });
