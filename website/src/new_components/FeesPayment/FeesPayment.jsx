...
import { TableBodyCellWrapper, TableFooterCellWrapper, TableHeaderCellWrapper, TableRowWrapper } from '../Table/Table';
...
const FeesPayment = ({ serverHost }) => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            // await axios.get(`${serverHost}/api/bkash/website/create-payment`, data)
            //     .then(testRes => { console.log({ testRes }) })
            //     .catch(testErr => { console.log({ testErr }) })


            // axios.post(`${serverHost}/api/onlineAdmission`, data).then((reqTest) => {
            //     console.log({ reqTest })
            // })
            ...
            const req = await axios.post(`${serverHost}/api/website-payment`, data)
            console.log({ req })
            router.push(req.data.bkashURL);
